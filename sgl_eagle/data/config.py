...
class DataConfig:
    ...
    def get_chat_template(self) -> Dict[str, str]:
        ...
        if self.model_type == ModelType.CUSTOM:
            return {
                "assistant_header": self.custom_assistant_header or CHAT_TEMPLATES[ModelType.LLAMA4]["assistant_header"],
                "user_header": self.custom_user_header or CHAT_TEMPLATES[ModelType.LLAMA4]["user_header"],
                "system_prompt": self.custom_system_prompt or CHAT_TEMPLATES[ModelType.LLAMA4]["system_prompt"]
            }
