...
class DSparkV4Expert(nn.Module):
...
class DSparkV4Gate(nn.Module):
    ...
    def __init__(self, config: DSparkV4DraftConfig):
        ...
        if config.scoring_func != "sqrtsoftplus":
            raise ValueError(
                f"DSpark V4 gate implements sqrtsoftplus scoring only, got "
...
class DSparkV4MoE(nn.Module):
    def __init__(self, config: DSparkV4DraftConfig):
        ...
        self.shared_experts = DSparkV4Expert(
