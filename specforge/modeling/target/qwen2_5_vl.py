...
from specforge.layers.linear import ColumnParallelLinear, RowParallelLinear, QKVParallelLinear
...
class Qwen2_5_VLVisionAttention(nn.Module):
    def __init__(self, config: Qwen2_5_VLVisionConfig) -> None:
        ...
        self.qkv = QKVParallelLinear(
            self.dim, self.head_dim, self.num_heads
        )
    ...
    def forward(
        ...
        **kwargs,
        ...
        query_states, key_states, value_states = (
            self.qkv(hidden_states).reshape(seq_length, 3, self.num_heads // self.tp_size, -1).permute(1, 0, 2, 3).unbind(0)
        )
...
class Qwen2_5_VLForConditionalGeneration(Qwen2_5_VLPreTrainedModel, GenerationMixin, DistributedTargetModel):
