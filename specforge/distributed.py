...
def init_distributed(
    ...
    sp_ulysses_group = process_group.ULYSSES_PG if process_group is not None else None
    sp_ring_group = process_group.RING_PG if process_group is not None else None
