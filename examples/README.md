...
| `examples/configs/kimi-k3-dspark-5mla-openperfectblend-disaggregated.yaml` | Kimi-K3 TP8 server capture + four-rank trainer | DSpark 5×MLA |
| `examples/configs/kimi-k3-dspark-4kda-1mla-openperfectblend-disaggregated.yaml` | Kimi-K3 TP8 server capture + four-rank trainer | DSpark 4×KDA+1×MLA |
