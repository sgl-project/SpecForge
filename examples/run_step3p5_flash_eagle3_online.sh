...
torchrun \
    ...
    --train-data-path cache/dataset/perfectblend_train.jsonl \
    --build-dataset-num-proc $BUILD_DATASET_NUM_PROC \
    --output-dir $ROOT_DIR/outputs/step-3.5-flash-eagle3-perfectblend-online \
    --tp-size $TP_SIZE \
    ...
    --wandb-name specforge-step3p5-flash-perfectblend
