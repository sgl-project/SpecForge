...
servers32k)
  ...
  ;;
train32k)
  launch_trainer examples/configs/online/disaggregated/external/deepseek-v4-flash-dspark-official-0813-32k-b200-2nodes.yaml
  ;;
*)
  echo "usage: $0 master|servers32k|train32k" >&2; exit 2 ;;
esac
