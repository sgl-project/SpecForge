...
from specforge import BF16Optimizer, build_tracker
...
class Eagle3TrainerArgs:
    ...
    def add_cli_args(parser: argparse.ArgumentParser):
        ...
        parser.add_argument(
            "--dist-timeout",
            type=int,
            default=Eagle3TrainerArgs.dist_timeout,
        ...
        parser.add_argument(
            ...
            "--tp-size",
            type=int,
            default=Eagle3TrainerArgs.target_tp_size,
        )
        parser.add_argument(
        ...
        parser.add_argument(
            "--chat-template",
            type=str,
            default=Eagle3TrainerArgs.chat_template,
        )
        parser.add_argument(
            "--enable-zero2",
            action="store_true",
