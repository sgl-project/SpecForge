...
CAPTURE_IP=192.0.2.10
TRAINER_IP=192.0.2.20
...
launch_trainer() {
  local config=$1
  # export HF_HOME=/path/to/shared/model/cache
  export MC_TRANSFER_TIMEOUT=300
...
servers32k)
  ...
  ;;
train)
  launch_trainer examples/configs/online/disaggregated/external/deepseek-v4-flash-dspark-official-2node-h200.yaml
  ;;
train32k)
  launch_trainer examples/configs/online/disaggregated/external/deepseek-v4-flash-dspark-official-0813-32k.yaml
  ;;
*)
  echo "usage: $0 master|servers|servers32k|train|train32k" >&2; exit 2 ;;
esac
