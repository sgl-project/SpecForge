...
def main():
    ...
    if args.dataset == "ultrachat":
        ...
        raise ValueError(
            f"This script only supports ultrachat_200k, sharegpt, opc, and synth_summarize datasets for demo purpose, if you wish to use other datasets, please modify this script."
        )
