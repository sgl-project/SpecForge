...
2026-08-22 on two 8xH200 nodes (10.220.51.50 / 10.220.51.52):

- **Capture node (10.220.51.50)**: `mooncake_master` + four TP2 capture
  ...
  not the bottleneck).
- **Trainer node (10.220.51.52)**: `specforge train` single supervisor = CPU
...
Config: `examples/configs/deepseek-v4-flash-dspark-2node-h200.yaml`.
...
specforge train -c examples/configs/deepseek-v4-flash-dspark-2node-h200.yaml
```
