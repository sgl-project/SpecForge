...
fig.suptitle(
    "EAGLE3 draft models — output throughput vs. the autoregressive baseline",
    x=0.045,
    y=1.02,
    ha="left",
    fontsize=12.5,
...
fig.savefig(
    "/data/projects/speculative/SpecForge/blog/eagle3-speedup.svg",
    facecolor=SURFACE,
    bbox_inches="tight",
)
fig.savefig(
    "/tmp/claude-0/-data-projects-speculative-SpecForge/5e63e05b-4a76-443f-9b3f-a3362bf893b8/scratchpad/eagle3-speedup.png",
    facecolor=SURFACE,
    dpi=140,
    bbox_inches="tight",
)
