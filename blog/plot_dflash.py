...
for ax, data, speedup, title, step in (
    ...
    ax.bar(x + half, data[:, 1], width, color=DFLASH_COLOR, linewidth=0,
           label="DFlash block=8", zorder=3)
...
fig.suptitle("Qwen3.5-397B-A17B DFlash (block size 8) vs. autoregressive baseline — 8 × B200",
...
fig.savefig("/data/projects/speculative/SpecForge/blog/dflash-speedup.svg",
            facecolor=SURFACE, bbox_inches="tight")
fig.savefig("/tmp/claude-0/-data-projects-speculative-SpecForge/5e63e05b-4a76-443f-9b3f-a3362bf893b8/scratchpad/dflash-speedup.png",
