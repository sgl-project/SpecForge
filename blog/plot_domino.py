...
fig.suptitle(
    "Qwen3.6-27B Domino (block size 8) vs. autoregressive baseline — 2 × A100",
    x=0.06,
    y=1.02,
    ha="left",
    fontsize=12.5,
...
fig.savefig(
    "/data/projects/speculative/SpecForge/blog/domino-speedup.svg",
    facecolor=SURFACE,
    bbox_inches="tight",
)
fig.savefig(
    "/tmp/claude-0/-data-projects-speculative-SpecForge/5e63e05b-4a76-443f-9b3f-a3362bf893b8/scratchpad/domino-speedup.png",
    facecolor=SURFACE,
    dpi=140,
    bbox_inches="tight",
)
