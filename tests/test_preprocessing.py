...
class TestPreprocessing(unittest.TestCase):
    ...
    def test_conversation_preprocessing_basic(self):
        ...
        self.assertTrue(torch.any(loss_mask == 1), "No tokens marked for loss computation")
        
        # Check that some tokens are not marked for loss (system/user parts)
        self.assertTrue(torch.any(loss_mask == 0), "All tokens marked for loss computation")
        ...
        if len(assistant_token_indices) > 0:
            ...
            assistant_text = self.tokenizer.decode(assistant_tokens, skip_special_tokens=False)
    ...
    def test_multiple_turns_conversation(self):
        ...
        assistant_token_indices = torch.where(loss_mask == 1)[0]
        self.assertTrue(len(assistant_token_indices) > 0, "No assistant tokens identified")
    ...
    def test_preformatted_conversation(self):
        ...
        self.assertTrue(torch.any(loss_mask == 1), "No assistant tokens marked in preformatted input")
    ...
    def test_assistant_span_boundaries(self):
        ...
        test_cases = [
            ...
            },
            {
                ...
                "conversation": [
                    ...
                    {"role": "assistant", "content": "Python is a programming language. It's very popular for AI."},
                ],
            ...
            },
            {
                ...
                "conversation": [
                    ...
                    {"role": "assistant", "content": "Sure! Here's an example: 2 + 2 = 4, and π ≈ 3.14159."},
                ],
        ...
        for test_case in test_cases:
            with self.subTest(test_case["name"]):
                ...
                assistant_token_indices = torch.where(loss_mask == 1)[0]
                self.assertTrue(len(assistant_token_indices) > 0, 
                ...
                self.assertNotIn(user_content, assistant_text,
