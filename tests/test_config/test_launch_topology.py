...
EXPECTED_NPROC_PER_NODE = {
    ...
    "deepseek-v4-flash-dspark-0813-128k.yaml": 4,
    "deepseek-v4-flash-dspark-0813-32k.yaml": 2,
    "deepseek-v4-flash-dspark-2node-h200.yaml": 8,
...
class ExampleLaunchTopologyTest(unittest.TestCase):
    def test_every_recipe_has_the_explicit_golden_topology(self):
        recipes = _recipes()
        self.assertEqual(len(EXPECTED_NPROC_PER_NODE), 71)
