...
class TestTrainEagle3(unittest.TestCase):
    ...
    def test_online_train_eagle3(self):
        ...
        script_path = Path(__file__).parent.parent.parent.joinpath("examples", "run_llama3.1_8b_eagle3_online.sh")
        ...
        # run training        
        train_process = execute_shell_command("bash examples/run_llama3.1_8b_eagle3_online.sh 2")
        train_process.wait()
