...
> Online mode only generates these hidden states on the fly without storing them to the disk, but needs to keep the target model alive during training, trading GPU RAM for almost-zero disk footprint.
